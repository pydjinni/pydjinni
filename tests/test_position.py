...
@pytest.mark.parametrize("text,cursor_start,cursor_end", [
    ("find a **match** in this text", Cursor(line=0, col=9), Cursor(line=0, col=14)),
    ("find a\n**match** in the second line\nof a text", Cursor(line=1, col=2), Cursor(line=1, col=7)),
])
