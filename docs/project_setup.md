...
and adapt it to your needs, or you can bootstrap a new project with the `project-init` setup wizard.
...
While both methods of setting up new projects currently only support CMake with Conan, PyDjinni is designed to be
