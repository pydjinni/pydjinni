...
function      : ASYNC? (FUNCTION targets)? LPAREN ((parameter COMMA)* parameter)? RPAREN THROWS? (ARROW typeRef)?;
targets       : TARGET*;
...
method        : comment? STATIC? CONST? ASYNC? identifier LPAREN ((parameter COMMA)* parameter)? RPAREN THROWS? (ARROW typeRef)? SEMI;
