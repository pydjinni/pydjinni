...
function      : ASYNC? (FUNCTION targets)? LPAREN ((parameter COMMA)* parameter)? RPAREN (ARROW typeRef)?;
targets       : TARGET*;
...
method        : comment? STATIC? CONST? ASYNC? identifier LPAREN ((parameter COMMA)* parameter)? RPAREN (ARROW typeRef)? SEMI;
